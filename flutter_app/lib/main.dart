...
//           children: [
//             // Use Expanded to make the image take available vertical space
//             Expanded(
//               child: Image.network(
//                 'https://upload.wikimedia.org/wikipedia/commons/1/10/Telaga_Warna_in_The_Dieng_Plateau.jpg',
//                 fit: BoxFit.cover,
//               ),
//             ),
//             Padding(
...
//             Padding(
//               padding: const EdgeInsets.all(8.0),
//               child: Text('Dieng, Kabupaten Wonosobo, Jawa Tengah, Indonesia'),
//             ),
//             // Use Expanded to make the text take available vertical space
//             Expanded(
//               child: Padding(
//                 padding: const EdgeInsets.all(8.0),
//                 child: Text(
...
//         body: Column(
//           children: [
//             Image.network('https://upload.wikimedia.org/wikipedia/commons/1/10/Telaga_Warna_in_The_Dieng_Plateau.jpg'),
//             Text(
//               'Telaga Warna Dieng.',
//               style: TextStyle(fontSize: 24, fontFamily: "serif",  height: 2.0),
//             ),
//             Text('Dieng, Kabupaten Wonosobo, Jawa Tengah, Indonesia'),
